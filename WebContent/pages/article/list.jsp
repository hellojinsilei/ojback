	...
	<body>
		...
		<div class="weadmin-body">
			...
			<div class="weadmin-block demoTable">
				...
				<button class="layui-btn" onclick="WeAdminShow('添加题目','/ojback/pages/article/add.jsp',1200,700)"><i class="layui-icon">&#xe61f;</i>添加</button>
				<span class="fr" style="line-height:40px">共有数据：8284条</span>
			</div>
...
<table class="layui-table" id="memberList">
				...
				<tbody>
					...
					<c:forEach var="U" items="${problemAll}"> 
	      ...
	      <td class="td-status">
				...
				<a title="查看" onclick="WeAdminShow('查看题目','/ojback/pages/article/show.html',1000,500)" href="javascript:;">
					<i class="layui-icon">&#xe63c;</i>
				</a>
