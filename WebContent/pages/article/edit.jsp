...
<html>
	...
	<body>
		<div class="weadmin-body">
			<form class="layui-form" action="../../UpdateProblem" method="post" id="reg_form">
				<div class="layui-form-item">
					<label for="username" class="layui-form-label">
                  <span class="we-red">*</span>题目名称
              </label>
					<div class="layui-input-inline">
						<input type="text" id="problem_name" name="problem_name" required="" lay-verify="required" autocomplete="off" class="layui-input" value="A+B Problem">
					</div>
				</div>
				<div class="layui-form-item">
					<label for="username" class="layui-form-label">
                  <span class="we-red">*</span>时间限制
					...
					<div class="layui-input-inline">
						<input type="text" id="time_limit" name="time_limit" required="" lay-verify="required" autocomplete="off" class="layui-input" value="400ms">
					</div>
				</div>
				<div class="layui-form-item">
                  ...
                  <span class="we-red">*</span>内存限制
					...
					<div class="layui-input-inline">
						<input type="text" id="memory_limit" name="memory_limit" required="" lay-verify="" autocomplete="off" class="layui-input" value="64MB">
					</div>
				</div>
				<div class="layui-form-item">
					<label for="username" class="layui-form-label">
                  <span class="we-red">*</span>题目难度
					...
					<div class="layui-input-inline">
						<input type="text" id="problem_difficulty" name="problem_difficulty" required="" lay-verify="required" autocomplete="off" class="layui-input" value="10">
					</div>
				</div>
				<div class="layui-form-item">
					<label for="username" class="layui-form-label">
                  <span class="we-red">*</span>题目价值
					...
					<div class="layui-input-inline">
						<input type="text" id="problem_value" name="problem_value" required="" lay-verify="required" autocomplete="off" class="layui-input" value="10">
					</div>
				</div>
				<div class="layui-form-item">
					<label for="username" class="layui-form-label">
			...
			<div class="layui-input-block">
				<textarea placeholder="请输入内容" id="desc" name="desc" class="layui-textarea">Description
Calculate a+b
...
Output a+b
		...
		<div class="layui-form-item">
			...
			<button class="layui-btn" lay-filter="" lay-submit="" onclick="checkDate()">修改</button>
		</div>
		</form>
		</div>
		<script>
