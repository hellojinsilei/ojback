...
<html>
	...
	<body>
        ...
        <a><cite>比赛列表</cite></a>
			...
			<a class="layui-btn layui-btn-sm" style="line-height:1.6em;margin-top:3px;float:right" href="ListCompetition" title="刷新">
		...
		<div class="weadmin-body">
			...
			<div class="weadmin-block">
				...
				<button class="layui-btn" onclick="WeAdminShow('添加订单','/ojback/pages/order/add.jsp')"><i class="layui-icon"></i>添加</button>
			...
			<table class="layui-table">
				...
				<tbody>
					...
					<c:forEach var="U" items="${serchCompetition}"  > 
