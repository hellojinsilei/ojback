        ...
        <a>
          <cite>课程列表</cite></a>
			...
			<a class="layui-btn layui-btn-sm" style="line-height:1.6em;margin-top:3px;float:right" href="javascript:location.replace(location.href);" title="刷新">
				<i class="layui-icon" style="line-height:30px" href="ListClass">&#x1002;</i></a>
		</div>
		<div class="weadmin-body">
			<div class="layui-row">
				<form class="layui-form layui-col-md12 we-search" action="SerchClass" method="post" id="reg_form">
					课程搜索：
					
					<div class="layui-inline">
						<input class="layui-input" type="text" placeholder="课程名称" id="class_name" name="class_name">
					</div>
					<div class="layui-inline">
						<input class="layui-input" placeholder="课程ID" id="class_id" name="class_id">
					</div>
...
<table class="layui-table" id="memberList">
				...
				<tbody>
					...
					<c:forEach var="U" items="${classAll}"> 
	      ...
	      <td class="td-status">
						...
						<td class="td-manage">
							<a title="编辑" onclick="WeAdminEdit('编辑','/ojback/pages/class/edit.jsp', 2, 1200, 700)" href="javascript:;">
