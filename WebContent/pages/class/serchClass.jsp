	...
	<body>
        ...
        <a>
          <cite>课程列表</cite></a>
			...
			<a class="layui-btn layui-btn-sm" href="ListClass" style="line-height:1.6em;margin-top:3px;float:right" href="javascript:location.replace(location.href);" title="刷新">
		...
		<div class="weadmin-body">
			<div class="layui-row">
				<form class="layui-form layui-col-md12 we-search" action="SerchProblem" method="post" id="reg_form">
					...
					<div class="layui-inline">
						<input class="layui-input" type="text" placeholder="课程名称" id="problem_name" name="problem_name">
					</div>
					<div class="layui-inline">
						<input class="layui-input" placeholder="课程ID" id="problem_creator_id" name="problem_creator_id">
					</div>
			...
			<div class="weadmin-block demoTable">
				...
				<button class="layui-btn" onclick="WeAdminShow('添加题目','/ojback/pages/class/add.jsp',1200,700)"><i class="layui-icon">&#xe61f;</i>添加</button>
...
<table class="layui-table" id="memberList">
				...
				<tbody>
					...
					<c:forEach var="U" items="${serchClass}"> 

       		<tr data-id="${U.class_id}">
						<td>
	       ...
	       <td>${U.class_type}</td>
	       <td>${U.class_log}</td>
	       <td>${U.class_pernum}</td>  
	      <td class="td-status">
							<span class="layui-btn layui-btn-normal layui-btn-xs">已上传</span></td>
						<td class="td-manage">
							<a title="编辑" onclick="WeAdminEdit('编辑','/ojback/pages/article/edit.jsp', 2, 1200, 700)" href="javascript:;">
